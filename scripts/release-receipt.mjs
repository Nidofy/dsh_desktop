...
export const inputFiles=['versions.json','src-tauri/Cargo.toml','src-tauri/Cargo.lock','src-tauri/tauri.conf.json','src-tauri/build.rs','.cargo/config.toml','build-deps/package.json','build-deps/package-lock.json','build-deps/harness-source.json','assets/icon-source.png','assets/wallpaper-transparent.png'];
